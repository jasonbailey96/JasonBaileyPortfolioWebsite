...
*/
	function lightbox_display($dir_to_search, $rel){
		...
		$image_exts = array('gif', 'GIF', 'jpg', 'JGP', 'jpeg', 'png');
...
<img src='".$image_dir.$filename.'.'.$filetype."' alt='".$filename."' max-width='300px' height='400px' padding='15px' title=''/> 
</a>"."\n";
				}
			}
	}
	
	/* line 23 is responsible for changing the thumbnail image size */
	?>
